<?php
    ...
    if ($_POST && $_POST['submit']) {
        ...
        $infoMessage = 'Upload Sukses ' . ($operation == 'Edit' ? 'edited' : 'added') . '!';
    ...
    '<section class="col-md-10 ">
        <form action="edit_book.php" method="post" class="form-horizontal">
            ...
            <fieldset>
                <legend>'.$operation.' Produk</legend>';
                if($infoMessage) {
                ...
                '<div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="title" id="title" placeholder="nama" class="form-control" value="'.$title.'">
                    </div>
                </div>
                <div class="form-group">
                    <label for="author" class="col-sm-2 control-label">Alamat</label>
                    <div class="col-sm-8">
                        <input type="text" name="author" id="author" placeholder="alamat" class="form-control" value="'.$author.'">
                    </div>
                </div>
                <div class="form-group">
                    <label for="genre_id" class="col-sm-2 control-label">Kategori</label>
                    <div class="col-sm-8">
